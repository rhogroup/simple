...
// This file reads the latitude and longitude values continuously as long as the right key is pressed and stores in a file
...
int main(int argc, char **argv)
{
	 ...
	 /**
	   ...
	   */
	  ros::init(argc, argv, "gps_points_collection");
	  ...
	  ofstream gpsFile;
	  char keyboardInput;
	  gpsFile.open ("gpsPointsSingleTest_11_06_2013.txt");
	  while (ros::ok())
	  {
		  std::cout << "Please press 's' to store the current GPS position and 'x' to exit";
